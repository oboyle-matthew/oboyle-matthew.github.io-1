...
function Friends() {
    const quotes = [
        ...
        {
            author: 'Abdullah Antepli (via the Duke Chronicle)',
            year: '2020',
            image: buddies,
        ...
        },
        {
            ...
            year: '2020',
            image: buddies,
            quote: 'There\`s no doubt Ibby is involved in a lot of things at Duke or within Durham (or so I\'ve been told), but to me, Ibby is plainly not only a true friend but someone I\'d call my brother. Whether it be obnoxious 3 am Taylor Swift karaoke or guilty late-night Krafthouse runs, Ibby has been there for me through thick and thin, and I know he\'ll carry the same energy into every relationship he makes.'
        },
    ];
    let reactSwipeEl;
    return (
